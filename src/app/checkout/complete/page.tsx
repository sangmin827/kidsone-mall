        ...
        <div className="rounded-3xl border border-[#E8E6E1] bg-white p-8 shadow-sm">
          ...
          {orderNumber && (
            <div className="mt-6 rounded-2xl bg-[#ede9fb] px-5 py-4 text-center">
              ...
              <p className="mt-1 text-lg font-bold tracking-wide text-[#222222]">
                {orderNumber}
              </p>
            </div>
          )}
            ...
            {bankAccounts.length === 0 ? (
              ...
              <div className="mt-3 space-y-2">
                {bankAccounts.map((account) => (
                  <div
                    key={account.id}
                    className="rounded-xl border border-[#E8E6E1] bg-[#FAF9F6] px-4 py-3 text-sm"
                  >
                    <div className="flex items-center justify-between">
                      <span className="font-semibold text-[#222222]">
                        {account.bank_name}
                      </span>
                      <span className="text-[#5332C9] font-bold">
          ...
          <div className="mt-5 rounded-2xl border border-[#FF5555]/20 bg-[#fff0f0] px-5 py-4 space-y-2">
            <p className="text-xs font-bold text-[#FF5555]">
              ⚠️ 입금 전 꼭 확인해 주세요
            </p>
            {[
              ...
              <p key={notice} className="text-xs leading-5 text-[#b91c1c]">
                • {notice}
              </p>
            ))}
          </div>
