      ...
      <div className="bg-white border-b border-[#E8E6E1]">
        <div className="section-inner py-6 sm:py-8">
          ...
          <p className="mt-1 text-sm text-[#6b7280]">
            전자상거래 등에서의 소비자보호에 관한 법률에 의거한 반품·교환·환불 정책입니다.
          </p>
        </div>
      </div>
      ...
      <div className="section-inner py-8 space-y-6 max-w-3xl">
        ...
        <section className="rounded-2xl border border-[#E8E6E1] bg-white p-6 sm:p-8">
          <h2 className="text-base font-bold text-[#222222] flex items-center gap-2">
            <span className="flex h-7 w-7 items-center justify-center rounded-full bg-[#ede9fb] text-sm text-[#5332C9] font-bold">1</span>
            청약철회 (단순 변심 반품)
          </h2>
          <div className="mt-4 space-y-2 text-sm text-[#6b7280] leading-7">
            <p>
              상품 수령 후 <span className="font-semibold text-[#222222]">7일 이내</span>에 청약철회(단순 변심 반품)가 가능합니다.
              (전자상거래소비자보호법 제17조)
            </p>
            <p>
              단, 아래의 경우 청약철회가 제한될 수 있습니다.
            </p>
            ...
            <div className="mt-3 rounded-xl bg-[#FAF9F6] border border-[#E8E6E1] px-4 py-3 text-xs text-[#6b7280]">
              <p className="font-semibold text-[#222222]">💡 반품 배송비 안내</p>
              <p className="mt-1">단순 변심에 의한 반품 시 왕복 배송비는 고객 부담입니다.</p>
            </div>
          </div>
        </section>
        ...
        <section className="rounded-2xl border border-[#FF5555]/20 bg-[#fff0f0] p-6 sm:p-8">
          <h2 className="text-base font-bold text-[#FF5555] flex items-center gap-2">
            <span className="flex h-7 w-7 items-center justify-center rounded-full bg-[#FF5555] text-sm text-white font-bold">2</span>
            교환·반품이 불가한 경우
          </h2>
          <ul className="mt-4 space-y-2">
            {[
              ...
              <li key={item} className="flex items-start gap-2 text-sm text-[#b91c1c]">
        ...
        <section className="rounded-2xl border border-[#E8E6E1] bg-white p-6 sm:p-8">
          <h2 className="text-base font-bold text-[#222222] flex items-center gap-2">
            <span className="flex h-7 w-7 items-center justify-center rounded-full bg-[#ede9fb] text-sm text-[#5332C9] font-bold">3</span>
            불량품 / 오배송 처리
          </h2>
          <div className="mt-4 space-y-2 text-sm text-[#6b7280] leading-7">
            <p>
              상품의 <span className="font-semibold text-[#222222]">제조 불량, 파손, 오배송</span>의 경우
              수령 후 <span className="font-semibold text-[#222222]">7일 이내</span>에 카카오톡 채널로 문의해 주세요.
            </p>
            <p>불량/오배송 확인 시 <span className="font-semibold text-[#222222]">왕복 배송비는 판매자 부담</span>으로 처리해 드립니다.</p>
            <p className="text-xs text-[#9ca3af]">
              * 문의 시 주문번호, 상품명, 불량 부위 사진을 함께 보내주시면 빠른 처리가 가능합니다.
            </p>
          </div>
        </section>
        ...
        <section className="rounded-2xl border border-[#E8E6E1] bg-white p-6 sm:p-8">
          <h2 className="text-base font-bold text-[#222222] flex items-center gap-2">
            <span className="flex h-7 w-7 items-center justify-center rounded-full bg-[#ede9fb] text-sm text-[#5332C9] font-bold">4</span>
            환불 절차 및 기간
          </h2>
          <div className="mt-4 space-y-3">
            {[
              { step: "01", title: "반품 접수", desc: "카카오톡 채널로 반품 의사 및 사유를 알려주세요." },
              { step: "02", title: "상품 회수", desc: "반품 주소 안내 후 상품을 발송해 주세요." },
              { step: "03", title: "상품 검수", desc: "반품 상품 수령 및 상태 확인 (1~2 영업일)." },
              { step: "04", title: "환불 처리", desc: "무통장입금은 고객 계좌로 환불 (검수 완료 후 3 영업일 이내)." },
            ].map((item) => (
              <div key={item.step} className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-[#6b7280] leading-5">{item.desc}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <section className="rounded-2xl border border-[#E8E6E1] bg-white p-6 sm:p-8">
          <h2 className="text-base font-bold text-[#222222] flex items-center gap-2">
            <span className="flex h-7 w-7 items-center justify-center rounded-full bg-[#ede9fb] text-sm text-[#5332C9] font-bold">5</span>
            배송비 부담 기준
          </h2>
            ...
            <table className="w-full text-xs sm:text-sm">
              <thead>
                <tr className="bg-[#FAF9F6] border-b border-[#E8E6E1]">
                  <th className="px-4 py-3 text-left font-semibold text-[#222222]">사유</th>
                  <th className="px-4 py-3 text-center font-semibold text-[#222222]">배송비 부담</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-[#E8E6E1] text-[#6b7280]">
                <tr>
                  <td className="px-4 py-3">단순 변심 반품</td>
                  <td className="px-4 py-3 text-center font-medium text-[#FF5555]">고객 부담</td>
                </tr>
                <tr>
                  <td className="px-4 py-3">제품 불량 / 오배송</td>
                  <td className="px-4 py-3 text-center font-medium text-[#22c55e]">판매자 부담</td>
                </tr>
                <tr>
        ...
        <section className="rounded-2xl bg-[#5332C9] px-6 py-8 text-center">
          <p className="text-sm font-bold text-white">반품·교환 문의는 카카오톡으로 편하게!</p>
          <p className="mt-1 text-xs text-[#c4b9f5]">운영시간 내 빠르게 답변드립니다.</p>
